...
const letters: Letter[] = [
  ...
  { title: "מכתב תודה מהרב איתן אקשטיין", sub: "מנהל רטורנו", img: `${cdn}/2026/05/איתן-אקשטיין-רטורנו.webp` },
  { title: "מכתב המלצה מבי\"ס בית אל חטיבת הביניים", sub: "הרב אליעזר קצובר רב בי\"ס", img: `${cdn}/2025/05/תמונה-של-WhatsApp‏-2025-05-18-בשעה-15.23.54_44db3e8d.jpg` },
