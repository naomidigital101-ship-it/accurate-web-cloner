...
const audiences = [
  ...
  ["משפחות שרוצות לדבר על אמונה", "סיפורים שאפשר לקרוא יחד ולדבר עליהם בבית."],
];
const faqs = [
...
function BookOrderPage() {
  ...
  return <div className="cb" dir="rtl">
    <main id="cb-main">
      <section className="cb-hero" aria-labelledby="cb-title">
        ...
        <div className="cb-wrap cb-hero-wrap">
          ...
          <div className="cb-hero-grid">
            <div className="cb-hero-copy"><h1 id="cb-title"><em>קשר של תפילין</em> — 23 סיפורים מהחיים על הנחת תפילין והתחלה של קשר</h1><p className="cb-lead">אנשים בגילים שונים ובמקומות שונים מספרים מה גרם להם להכניס את התפילין לחיים. ספר על החלטות אישיות, שיחות במשפחה ורגעים ששינו כיוון.</p><div className="cb-hero-actions"><a className="cb-button" href="#cb-offer">להזמנת הספר <span aria-hidden="true">←</span></a><a className="cb-text-link" href="#cb-sample">לקריאת קטע מהספר</a></div><ul className="cb-hero-checks"><li>✓ 184 עמודים · כריכה רכה</li><li>✓ משלוח עד הבית או איסוף עצמי מבית אל</li><li>✓ תשלום מאובטח ב־Grow</li></ul></div>
      ...
      <section className="cb-section" data-reveal><div className="cb-wrap"><div className="cb-section-heading"><p className="cb-eyebrow">איך קוראים את הספר</p><h2>כל סיפור עומד בפני עצמו</h2><p>אפשר לקרוא ברצף, ואפשר לפתוח בכל פעם סיפור אחד. הפרקים קצרים ומתאימים גם לקריאה משותפת ולשיחה.</p></div><div className="cb-pillars"><article><span>01</span><h3>184 עמודים</h3><p>23 סיפורים בכריכה רכה ובעברית.</p></article><article><span>02</span><h3>בלי הטפה</h3><p>האנשים והבחירות שלהם עומדים במרכז.</p></article><article><span>03</span><h3>לקריאה יחד</h3><p>ספר שאפשר לפתוח בבית, בשבת או לקראת בר מצווה.</p></article></div><div className="cb-funnel-cta"><a className="cb-button cb-button-quiet" href="#cb-offer">לבחירת מארז <span aria-hidden="true">←</span></a></div></div></section>
