      ...
      <section className="cb-hero" aria-labelledby="cb-title">
        ...
        <div className="cb-wrap cb-hero-wrap">
          ...
          <div className="cb-hero-grid">
            <div className="cb-hero-copy"><p className="cb-kicker">הספר של מיזם ״קשר של תפילין״</p><h1 id="cb-title">23 סיפורים אמיתיים על אנשים <em>שהתחילו להניח תפילין</em></h1><p className="cb-lead">כל פרק מספר מה קרה לאדם אחר, מה גרם לו להתחיל ואיך התפילין נכנסו לחיים שלו.</p><div className="cb-hero-actions"><a className="cb-button" href="#cb-offer">לבחירת מארז ותשלום <span aria-hidden="true">←</span></a><a className="cb-text-link" href="#cb-sample">לקריאת קטע מהספר</a></div><p className="cb-from">עותק אחד ב־78 ₪ · איסוף עצמי ללא עלות או משלוח עד הבית</p><ul className="cb-hero-checks"><li>✓ תשלום מאובטח</li><li>✓ משלוח עד 8 ימי עסקים</li><li>✓ ביטול לפי חוק</li></ul></div>
