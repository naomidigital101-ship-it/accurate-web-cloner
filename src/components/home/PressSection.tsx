...
const quotes: Quote[] = [
  ...
  { text: "", name: "ע.", city: "מקריית אונו", img: "/wp/img/AdobeStock_93382125-min.webp", href: "/tefilin/%d7%95%d6%b0%d7%a8%d6%b8%d7%90%d7%95%d6%bc-%d7%9b%d6%b8%d6%bc%d7%9c-%d7%a2%d6%b7%d7%9e%d6%b5%d6%bc%d7%99-%d7%94%d6%b8%d7%90%d6%b8%d7%a8%d6%b6%d7%a5-%d7%9b%d6%b4%d6%bc%d7%99-%d7%a9%d6%b5%d7%81%d7%9d-2" },
  { text: "בע\"ה אני אהיה בעוד כמה שבועות בן 90. היום קיבלתי תפילין, ולא יכולתי לבקש מתנה יותר מיוחדת ומרגשת לכבוד יום ההולדת שלי. בברית מילה שעשו לי כשהייתי בן 8 ימים קיבלתי את השם: מאיר. כל החיים קראו לי בשם הרוסי: מיכאל. אבל מעכשיו – אחרי שהתחלתי להניח תפילין – אני מבקש שתקראו לי בשם היהודי שלי: מאיר!", name: "מיכאל", city: "מירושלים", img: "/wp/img/unfocused-people-walking-min.webp" },
  { text: "אמרתי לעצמי: \"ביקשת סימן? קיבלת! אתה צריך לחזור ולהניח תפילין!\"", name: "א'", city: "ממעלה אדומים", img: "/wp/img/glitter-min.webp", href: "/tefilin/%d7%91%d7%99%d7%a7%d7%a9%d7%aa-%d7%a1%d7%99%d7%9e%d7%9f-%d7%a7%d7%99%d7%91%d7%9c%d7%aa" },
  ...
  { text: "החלטתי להמשיך עם המטען הרוחני שמילא אותי. בבית לא ממש תמכו במהלך הזה – לא קיבלתי מעטפת נוחה כדי לשמור שבת, אבל החלטתי שכאשר אתחתן – אתחזק יותר. מדי פעם אני מניח תפילין עם חברים או בלי חברים. לפני כמה זמן הגעתי להחלטה שאני רוצה להניח תפילין בכל יום.", name: "ג'", city: "מקיבוץ גשר הזיו", img: "/wp/img/6-1.png", href: "/tefilin/%d7%a9%d7%9c%d7%95%d7%97%d7%99-%d7%9e%d7%a6%d7%95%d7%95%d7%94" },
  { text: "סוף סוף יש לי תפילין! סוף סוף אני יודע להניח תפילין!", name: "א'", city: "מרגבה", img: "/wp/img/חצי-פנים-6.png", href: "/tefilin/%d7%a1%d7%95%d7%a3-%d7%a1%d7%95%d7%a3-%d7%99%d7%a9-%d7%9c%d7%99-%d7%aa%d7%a4%d7%99%d7%9c%d7%99%d7%9f-%d7%a1%d7%95%d7%a3-%d7%a1%d7%95%d7%a3-%d7%90%d7%a0%d7%99-%d7%99%d7%95%d7%93%d7%a2-%d7%9c%d7%94" },
  { text: "\"מה זאת אומרת? אנחנו לומדים תורה, לומדים גמרא…\"", name: "ע'", city: "מקרית אונו", img: "/wp/img/5.png", href: "/tefilin/%d7%95%d6%b0%d7%a8%d6%b8%d7%90%d7%95%d6%bc-%d7%9b%d6%b8%d6%bc%d7%9c-%d7%a2%d6%b7%d7%9e%d6%b5%d6%bc%d7%99-%d7%94%d6%b8%d7%90%d6%b8%d7%a8%d6%b6%d7%a5-%d7%9b%d6%b4%d6%bc%d7%99-%d7%a9%d6%b5%d7%81%d7%9d" },
  { text: "\"הרב עמיחי, כבר כמה שבועות שאין לי תפילין וזה מאד חסר לי. לצערי אין יכולת לקנות זוג חדש, אשמח שתעזור לי!\"", name: "י'", city: "מת\"א", img: "/wp/img/י-יותר.png", href: "/tefilin/%d7%9c%d6%b7%d7%a2%d6%b2%d7%a9%d7%82%d7%95%d6%b9%d7%aa-%d7%90%d6%b6%d7%aa-%d7%94%d6%b7%d7%a9%d6%b7%d6%bc%d7%81%d7%91%d6%b8%d6%bc%d7%aa" },
  { text: "\"אני בטוח שאחזור בתשובה. מה שלא יהיה – אשלח את הילדים שלי לחינוך דתי חרדי. העלויות של התפילין גבוהות מדי עבורי. האם תוכל לדאוג לי לזוג תפילין?\".", name: "נ'", city: "משדרות", img: "/wp/img/תמונה-של-WhatsApp_-2025-05-18-בשעה-15.24.png", href: "/tefilin/%d7%95%d6%b0%d7%90%d6%b5%d7%a8%d6%b7%d7%a9%d6%b0%d7%82%d7%aa%d6%b4%d6%bc%d7%99%d7%9a%d6%b0-%d7%9c%d6%b4%d7%99-%d7%91%d6%b0%d6%bc%d7%a6%d6%b6%d7%93%d6%b6%d7%a7-%d7%95%d6%bc%d7%91%d6%b0%d7%9e%d6%b4" },
  { text: "החלטתי שאני רוצה שיהיו לי תפילין משלי, כדי שאניח בכל יום. זה יחבר אותי לעם שלי ולארץ שלי ולעצמי. המחיר של תפילין חדשות יקר עבורי ולא אוכל לרכוש לעצמי.", name: "ב'", city: "מברלין", img: "/wp/img/7-225x300-1.png", href: "/tefilin/%d7%99%d7%95%d7%aa%d7%a8-%d7%98%d7%95%d7%91-%d7%9e%d7%90%d7%a1%d7%a4%d7%a8%d7%a1%d7%95" },
  { text: "\"זה מרגש אותי כל כך שהבן שלי קיבל על עצמו להניח בכל יום, ועכשיו הוא רוצה שיהיה לו זוג תפילין משלו!\"", name: "ע'", city: "מראשון לציון", img: "/wp/img/סיפור-1-תמונה-186x300-1.png", href: "/tefilin/%d7%94%d7%90%d7%9e%d7%90-%d7%94%d7%99%d7%99%d7%aa%d7%94-%d7%9e%d7%95%d7%a4%d7%aa%d7%a2%d7%aa-%d7%9e%d7%9e%d7%94-%d7%a9%d7%92%d7%99%d7%9c%d7%aa%d7%94-%d7%a2%d7%9c-%d7%94%d7%91%d7%9f-%d7%a9%d7%9c%d7%94" },
  { text: "הנחתי היום בפעם הראשונה את התפילין החדשות וזה ממש מדהים, מעולם לא היה לי תפילין משלי ועכשיו יש לי הרגשה בתפילה שונה והרבה יותר גדולה. בנוסף, עכשיו הילדים שלי יגדלו בבית שמניח תפילין וזה חשוב ומאוד משמח אותי.", name: "ע'", city: "מחיפה", img: "/wp/img/AdobeStock_817584046-min.webp", href: "/tefilin/%d7%94%d7%a1%d7%99%d7%a4%d7%95%d7%a8-%d7%a9%d7%9c-%d7%a2" },
